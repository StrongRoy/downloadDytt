...
BASE_DIMAIN2 = "https://www.ygdy8.net"  # 定义基础域名
HEADERS = {
...
# 获取电影列表页的链接
def movie_list_page():
    base_url = "http://s.ygdy8.com/plus/so.php?keyword=%BC%CD%C2%BC%C6%AC&searchtype=titlekeyword&channeltype=0&orderby=&kwtype=0&pagesize=10&typeid=1&TotalResult=34&PageNo={}"
    for x in range(1, 5):
...
def get_detail_url(url):
    ...
    # //*[@id="header"]/div/div[3]/div[3]/div[2]/div[2]/div[2]/ul/table[1]/tbody/tr[1]/td[2]/b/a
    detail_urls = html.xpath("//table[@width='100%']//a[@href!='/html/gndy/dyzz/index.html']/@href")
    res = []
    for x in detail_urls:
        res.append(BASE_DIMAIN + x)
    for x in detail_urls:
        res.append(BASE_DIMAIN2 + x)
...
if __name__ == '__main__':
    ...
    for (index, page_url) in page_urls:
        ...
        file_name = "jilupian/new_movie_" + str(index) + ".json"  # 设置存放每一页电影信息的json文件的名称
